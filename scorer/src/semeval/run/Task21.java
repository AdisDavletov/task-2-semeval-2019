...
public class Task21 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //argsSet.add("-verbose");
        String inputGold = args[0];//
        //"../lr/semeval/trial-public/gold/task-2.1.txt";
        String systemFile = args[1];//
       // "../lr/semeval/trial-public/test/task-2.1.txt";
        String syntaxBaseFile = null;
        if (args.length > 2 && !args[2].startsWith("-")) {
            syntaxBaseFile = args[2];//
            //"../lr/semeval/trial-public/baseline-files/task-2.1.verb-gr.txt";
        }
        MetricForArgumentsTask21 mfg = null;
        ...
        try {
            ...
            mfg = new MetricForArgumentsTask21(0, inputGold);
...
//        } else 
        if (argsSet.contains("-verbose")) {
            ...
            if (syntaxBaseFile != null) {
                EvaluationResult bl1CPerGramRel = mfg.createBaseline1ClusterPerVerbGramaticalRelationship(inputGold, syntaxBaseFile);
