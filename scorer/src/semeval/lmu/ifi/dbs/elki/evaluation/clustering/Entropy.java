...
public class Entropy {
   ...
   */
    ...
    public double getHomeginity() {
        if (this.entropyFirst == 1) {
            return 0;
        } else {
            return 1 - this.entropyConditionalFirst() / this.entropyFirst;
        }
    }
    
    public double getCompleteness() {
        if (this.entropySecond == 1) {
            return 0;
        } else {
            return 1 - this.entropyConditionalSecond()/ this.entropySecond;
        }
    }
    
    public double getVMeasure(){
        double h = getHomeginity();
        double c = getCompleteness();
        return 2* h*c/(h+c);
    }
